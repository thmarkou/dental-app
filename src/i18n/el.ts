...
export const el = {
  ...
  appointments: {
    ...
    reminderPreview: 'Υπενθύμιση {hours} ώρες πριν ({channels})',
    reminderSentAt: 'Στάλθηκε υπενθύμιση: {when}',
    reminderChannelsPush: 'ειδοποίηση',
    reminderChannelsSms: 'SMS',
    sendReminderNow: 'Αποστολή SMS τώρα',
    sendReminderFailed: 'Αποτυχία αποστολής υπενθυμίσεως',
    sendReminderSuccess: 'Η υπενθύμιση στάλθηκε.',
    reminderDisabledStatus: 'Οι υπενθυμίσεις είναι απενεργοποιημένες στις Ρυθμίσεις.',
    moreAppointments: '+{count} ακόμα',
    weekPlanLegend:
  ...
  settings: {
    ...
    appointmentRemindersDesc:
      'Τοπική ειδοποίηση στη συσκευή και/ή SMS (απαιτεί ρύθμιση gateway).',
    appointmentRemindersEnabled: 'Ενεργές υπενθυμίσεις',
    hoursBefore24: '24 ώρες πριν',
    hoursBefore48: '48 ώρες πριν',
    channelLocalPush: 'Ειδοποίηση (συσκευή)',
    channelSms: 'SMS',
    testSms: 'Δοκιμαστικό SMS',
    ...
    autoDeductInventory: 'Αυτόματη αφαίρεση υλικών',
    autoDeductInventoryHint:
      'Αν είναι OFF, εμφανίζεται το γνωστό παράθυρο «Ναι / Όχι» μετά την καταχώρηση θεραπείας.',
  ...
  reports: {
    ...
    revenue: 'Έσοδα (εισπράξεις)',
    charges: 'Χρεώσεις (θεραπείες)',
    revenueVsChargesHint:
      'Έσοδα = πληρωμές του μήνα · Χρεώσεις = κόστος καταχωρημένων θεραπειών',
    newPatients: 'Νέοι ασθενείς',
    totalReceivables: 'Συνολικές απαιτήσεις',
    totalReceivablesHint: 'Όλα τα ανοιχτά υπόλοιπα ασθενών (χρεώσεις − πληρωμές)',
    pendingInvoices: 'Εκκρεμή τιμολόγια',
    pendingInvoicesHint: 'Πρόχειρα ή εκδοθέντα, χωρίς πληρωμή',
    noPendingInvoices: 'Δεν υπάρχουν εκκρεμή τιμολόγια',
  ...
  inventory: {
    ...
    stockValueHint: 'Ποσότητα × κόστος μονάδας (όπου έχει καταχωρηθεί)',
    usageThisMonth: 'Κατανάλωση (μήνας)',
    usageThisMonthHint: 'Σύνολο τεμαχίων από κινήσεις «χρήση»',
    proceduresLinked: 'Θεραπείες με BOM',
    practiceRecentMovements: 'Πρόσφατες κινήσεις (όλα τα είδη)',
    noPracticeMovements: 'Δεν υπάρχουν κινήσεις ακόμα.',
    filterAll: 'Όλα',
    filterLow: 'Λίγα τεμάχια',
    filterExpiringSoon: 'Λήγουν σύντομα',
    filterExpired: 'Ληγμένα',
    empty: 'Δεν υπάρχουν είδη.',
    emptyLow: 'Κανένα είδος κάτω από το όριο.',
    emptyExpiringSoon: 'Κανένα είδος που λήγει τις επόμενες 30 ημέρες.',
    emptyExpired: 'Κανένα είδος με ληγμένη ημερομηνία.',
    expired: 'Ληγμένο',
    expiringSoon: 'Λήγει σύντομα',
    expiryDate: 'Ημερομηνία λήξης',
    expiryDateHint: 'Προαιρετικό · μορφή ΕΕΕΕ-ΜΜ-ΗΗ (π.χ. 2026-12-31)',
    expiryDatePlaceholder: '2026-12-31',
    invalidExpiryDate: 'Μη έγκυρη ημερομηνία λήξης (χρησιμοποιήστε ΕΕΕΕ-ΜΜ-ΗΗ).',
    expiringSoonCount: 'Λήγουν σύντομα',
    expiredCount: 'Ληγμένα',
    addItem: 'Νέο είδος',
    ...
    linkProcedures: 'Σύνδεση με θεραπείες',
  },

  procedureInventory: {
    title: 'Θεραπείες ↔ αποθήκη',
    subtitle: 'Ποια υλικά αφαιρούνται ανά τύπο θεραπείας',
    openFromInventory: 'Σύνδεση καταλόγου θεραπειών με υλικά',
    groupTooth: 'Ανά δόντι',
    groupGeneral: 'Γενικές / χωρίς δόντι',
    linkedCount: '{n} υλικά',
    notLinked: 'Χωρίς σύνδεση',
    editorHint:
      'Ορίστε ποσότητα ανά καταχώρηση θεραπείας. Μετά την αποθήκευση θεραπείας θα σας ζητηθεί αφαίρεση από την αποθήκη.',
    noLines: 'Δεν έχουν οριστεί υλικά για αυτή τη θεραπεία.',
    addMaterial: 'Προσθήκη υλικού',
    pickMaterial: 'Επιλογή από αποθήκη',
    qtyPerTreatment: 'Ποσότητα',
    duplicateItem: 'Το υλικό υπάρχει ήδη στη λίστα.',
    noInventoryItems: 'Προσθέστε πρώτα είδη στην αποθήκη.',
    loadFailed: 'Αποτυχία φόρτωσης συνδέσεων.',
    saveFailed: 'Αποτυχία αποθήκευσης.',
    saved: 'Οι συνδέσεις αποθηκεύτηκαν.',
    deductTitle: 'Αφαίρεση από αποθήκη;',
    deductBody: 'Θα αφαιρεθούν τα παρακάτω υλικά:',
    deductLine: '• {name}: {qty} {unit}',
    deductConfirm: 'Αφαίρεση',
    deductSkip: 'Όχι τώρα',
    deductSuccess: 'Τα υλικά αφαιρέθηκαν από την αποθήκη.',
    deductFailed: 'Αποτυχία αφαίρεσης υλικών.',
    insufficientStock: 'Δεν υπάρχει επαρκές απόθεμα για όλα τα υλικά.',
    usageNotePrefix: 'Θεραπεία:',
  },
